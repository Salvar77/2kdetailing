...
export async function generateMetadata({ params }) {
  ...
  const ogImageSrc =
    typeof realization.image === "object" && realization.image !== null
      ...
      : realization.image || "/og/logo-2kdetailing-opole.png";
...
export default async function GaleriaStronaPage({ params }) {
  const { slug } = await params;
  ...
  const breadcrumbJsonLd = {
    ...
    itemListElement: [
      ...
      },
      {
        "@type": "ListItem",
        position: 3,
        name: realization.description,
        item: `https://www.2kdetailing.opole.pl/galeria/${slug}`,
      },
    ],
  };
  ...
  return (
    <>
      ...
      />
      <GaleriaClient realization={realization} />
    </>
  );
}
