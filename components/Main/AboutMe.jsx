  ...
  return (
    <section className={classes.about}>
      <div className={classes.about__content}>
        ...
        >
          2K Auto Detailing – pasjonat perfekcji w każdym calu
        </motion.p>
      ...
      <div className={classes.about__image}>
        <Image
          src={AboutImage}
          alt="Właściciel 2K Auto Detailing, Kamil. Profesjonalny Auto Detailing Opole: korekta lakieru i polerowanie lakieru."
          fill
